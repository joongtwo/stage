                                                ...
                                                <li className='aw-notification-cellListItem' key={j}>
                                                    ...
                                                    <div id='cellProperties'>
                                                        <div className='aw-widgets-cellListCellProperties'>
                                                            <div onClick={( event )=>{ handleClick( event, linkObject ); }} onKeyDown={( event )=>{ handleClick( event, linkObject ); }}  role='link' title ={linkObject.subject} tabIndex='0' className='aw-notificationAlert-subjectLink'>
                                                                {linkObject.subject}
                                                            </div>
                                                        </div>
                                                        <div className='aw-widgets-cellListCellProperties'>
