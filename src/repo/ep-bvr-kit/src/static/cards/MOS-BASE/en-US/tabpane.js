...
var WebFXNav = new Array( 0 );
var WebFXInitialSelected = 0;
...
function hasSupport() {
    ...
    if ( ie55 ) {
        ...
        document.getElementsByTagName = function( sTagName ) {
            if ( sTagName === '*' ) { return document.all; }
...
function WebFXTabPane( el, bUseCookie ) {
    ...
    if( WebFXInitialSelected > 0 ) { this.selectedIndex = WebFXInitialSelected; }
...
WebFXTabPage.prototype.select = function() {
    ...
    if( WebFXNav.length > this.index ) { Function( WebFXNav[this.index] ); }
};
...
function setupAllTabs() {
    ...
    for ( var i = 0; i < l; i++ ) {
        ...
        if ( tabPaneRe.test( cn ) && !el.tabPane ) { new WebFXTabPane( el, false ); }
...
// DOM2
if ( typeof window.addEventListener !== 'undefined' ) { window.addEventListener( 'load', setupAllTabs, false ); }
