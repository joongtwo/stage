...
export let updateReportsCtxForFilters = function( subPanelContext, data ) {
    if( appCtxService.ctx.state.params.configure === 'true' ) {
        ...
        let nwreportCtx = { ...reportCtx.value };
        nwreportCtx.searchFilterColumnProps = finalFilterList;
        nwreportCtx.searchFilterChartProps = chartByFilterList;
        reportCtx.update( nwreportCtx );
