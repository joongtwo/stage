 ...
 */
export const createDynamicTablePropertyViewModel = function( uniqueName, objectSetSource, parentUid, columns, firstPageUids, objects, editContextKey, selectionData, operationName ) {
