...
class ViewerMeasurementManager {
    ...
    startViewerMeasurement( measurementMode ) {
        ...
        let renderOptions = viewerPreferenceService.getRenderSource(this.viewerContextData);
        var isUseTransparency = this.viewerContextData.getValueOnViewerAtomicData( 'viewerPreference.AWC_visSelectionDisplay' );
        if( renderOptions && renderOptions.length && renderOptions[ 0 ] === 'CSR' && isUseTransparency ) {
    ...
    closeViewerMeasurement() {
        ...
        let renderOptions = viewerPreferenceService.getRenderSource(this.viewerContextData);
        if( renderOptions && renderOptions.length && renderOptions[ 0 ] === 'CSR' && _previousTransparancyMode ) {
