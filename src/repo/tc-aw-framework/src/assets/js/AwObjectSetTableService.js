...
import { isObjectSetSourceDCP } from 'js/xrtUtilities';
...
export const getDynamicTableComponent = function( vmDef, prop ) {
    return [ new DerivedStateResult( {
        ctxParameters: [],
        additionalParameters: [ prop.columns, prop.objectSetData, prop.objectSetUri, prop.isCompareTable, prop.editContextKey, prop.isRefreshAllObjectSets ],
        compute: ( renderContext, columns, objectSetData, objectSetUri, isCompareTable, editContextKey, isRefreshAllObjectSets ) => {
                ...
                actions: {
                    ...
                    initialize: {
                        ...
                        inputData: {
                            ...
                            columnProvider: `{{data.grids.${dpName}.columnProviderInstance}}`,
                            dpRef: '{{props.dpRef}}',
...
export const arrangeObjectSetColumns = ( eventData, dpName, viewModel, objectSetUri, isCompareTable ) => {
