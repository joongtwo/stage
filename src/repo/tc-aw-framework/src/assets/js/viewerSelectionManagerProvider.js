...
class ViewerSelectionManager {
    ...
    initialize() {
        ...
        viewerPreferenceService.getViewerPreferences().then( function( viewerPrefs ) {
            if( viewerPrefs.selection.selectionDisplayStyle === viewerPreferenceService.SelectionDisplayStyle.BBOX_GRAYSEETHRU ) {
                this.setViewerContextDisplayStyle( viewerPreferenceService.ContextDisplayStyle.COLOREDSEETHRU );
            } else if( viewerPrefs.selection.selectionDisplayStyle === viewerPreferenceService.SelectionDisplayStyle.HIGHLIGHT ) {
                this.setViewerContextDisplayStyle( viewerPreferenceService.ContextDisplayStyle.NONE );
            }
        }.bind( this ) );
    }
    ...
    set3DInitiatedSelectionCounter( isAdd ) {
        if( isAdd ) {
            this.is3DInitiatedSelectionCounter++;
        } else {
            this.is3DInitiatedSelectionCounter--;
        }
    }
