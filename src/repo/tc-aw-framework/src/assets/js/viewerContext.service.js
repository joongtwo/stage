...
export let toggleUseTransparency = function( viewerContextData ) {
    ...
    if ( activeToolAndInfoCmd && activeToolAndInfoCmd.commandId === 'Awv0ViewerSettings' ) {
        var viewerTransparentFlagPath = VIEWER_NAMESPACE_TOKEN + '.isTransparencyUpdated';
        appCtxService.updateCtx( viewerTransparentFlagPath, true );
    }
};
