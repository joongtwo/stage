...
export let processGroupOrRoleNode = function( subPanelContext, groupRoleNode, type, levelNdx, childNdx, isExpanded ) {
    ...
    if( groupRoleNode.tcRole.type === 'unknownType' && groupRoleNode.tcGroup.type !== 'unknownType' ) {
        displayName = groupRoleNode.tcGroup.props.object_full_name.uiValues[ 0 ];
        ...
        displayName = groupRoleNode.tcGroup.props.object_full_name.uiValues[ 0 ] + '.' + groupRoleNode.tcRole.props.role_name.uiValues[ 0 ];
    ...
    if( objUid !== '' ) {
        vmNode = awTableSvc.createViewModelTreeNode( objUid, vmNodeType, displayName, levelNdx, childNdx, iconURL );
...
export let loadRootNode = function( searchResults, treeLoadInput, data, subPanelContext ) {
    ...
    var treeLoadResult = awTableSvc.buildTreeLoadResult( newTreeLoadInput, vmNodes, true, startReachedVar,
