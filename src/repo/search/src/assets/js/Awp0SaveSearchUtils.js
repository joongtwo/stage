...
export const processOutput = ( data, dataCtxNode, searchData ) => {
    ...
    newSearchData.searchFilterMap = data.searchFilterMap6;
...
export const setCurrentChartBy = ( searchState ) => {
    if( searchState.objectsGroupedByProperty &&
        ...
        newSearchState.currentChartBy = AwChartDataProviderService.getTargetSearchFilterCategory( searchState, searchState.objectsGroupedByProperty.internalPropertyName );
        newSearchState.currentChartBy = !newSearchState.currentChartBy || newSearchState.currentChartBy === '' ? {
            displayName: 'Category',
            internalName: 'Categorization.category'
        } : newSearchState.currentChartBy;
