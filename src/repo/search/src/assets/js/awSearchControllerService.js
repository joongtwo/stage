...
export let saveCurrentSearch = function( currentSearch ) {
    ...
    awSearchControllerService.publishSavedSearchList( cachedSearchObjects );
};
 ...
 */
export let retrieveRecentSearchObjects = function( userUidString ) {
 ...
 */
export const retrieveRecentSearchObjectsFiltered = ( userUidString, criteria ) => {
    let recents = [];
    let recentsValue = [];
    let recentsAll = awSearchControllerService.retrieveRecentSearchObjects( userUidString );
...
export let publishSavedSearchList = function( savedSearchList ) {
    localStrg.publish( ctrl._LS_TOPIC, JSON.stringify( savedSearchList ) );
};

//Unpublish the search list from the local storage
export let clearLocalStorage = function( displayClearAll ) {
