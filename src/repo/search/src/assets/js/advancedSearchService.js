 ...
 */
export let doAdvancedSearch = function( savedQueryObject, awp0AdvancedQueryAttributes, searchState, skipUrl ) {
    var queryUID = savedQueryObject.dbValue;
    var criteria = {
        queryUID: queryUID,
        searchID: advancedSearchUtils.getSearchId( queryUID ),
...
export const processOutput = ( data, searchState ) => {
    ...
    newSearchData.filterMap = data.searchFilterMap6;
